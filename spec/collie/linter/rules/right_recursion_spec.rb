...
RSpec.describe Collie::Linter::Rules::RightRecursion do
  ...
  describe "#check" do
    it "detects direct right recursion" do
      ...
      expect(offenses.first.message).to include("right recursion")
    end

    it "allows non-right-recursive rules" do
      grammar = create_grammar({
